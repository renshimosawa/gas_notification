...
shop1 = soup1.find_all(class_="title")
entries1 = soup1.find_all(class_="price-card")
message_s = f'\n今日の{shop1[0].text}{entries1[0].find(class_="mode-label").text}の価格は{entries1[0].find(class_="price").text}円です'
print( f'今日の{shop1[0].text}{entries1[0].find(class_="mode-label").text}の価格は{entries1[0].find(class_="price").text}円です')
...
shop2 = soup2.find_all(class_="title")
entries2 = soup2.find_all(class_="price-card")
message_y = f'今日の{shop2[0].text}{entries2[0].find(class_="mode-label").text}の価格は{entries2[0].find(class_="price").text}円です'
print( f'今日の{shop2[0].text}{entries2[0].find(class_="mode-label").text}の価格は{entries2[0].find(class_="price").text}円です')
